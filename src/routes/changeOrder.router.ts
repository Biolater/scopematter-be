...
import { createChangeOrderController, getChangeOrdersController, updateChangeOrderController, getChangeOrderController, deleteChangeOrderController, exportChangeOrderController } from "../controllers/changeOrder.controller";
...
changeOrderRouter.get("/:id/export", requireAuth, exportChangeOrderController);
